...
```{r plot province, fig.width=5, fig.height=4, fig.cap=paste('Figure 2. Horse populations for', params$province, 'between 1940 - 1972.'), out.width='50%'}
